/**
 * Lightweight QRCode generation library for browser canvas/DOM.
 * Bundled and zero-dependency for offline/instant generation.
 */
var QRCode;
(function(){
    function QR8bitByte(data){
        this.mode=4; // MODE_8BIT_BYTE (Mode 1 is numeric only)
        this.data=data;
    }
    ...
    QRCode.prototype.makeCode = function(text){
        var qrcode = new QRCodeModel(-1, this._opts.correctLevel);
        qrcode.addData(text);
        qrcode.make();
        ...
        var tileW = this._opts.width / count;
        var tileH = this._opts.height / count;
